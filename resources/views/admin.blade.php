                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" id="form-edit-client">
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Asignar nuevo ticket a usuario</legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" id="saveupdate">
                            <button id="btn-save" name="btn-save" class="btn btn-success"
                                onclick="addClient()">Guardar</button>
                        </div>
                    </div>
                                ...
                                @foreach ($tickets as $index_tickets => $ticket)
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <button class="btn btn-sm btn-danger" onclick="deleteClient({{$index_tickets}})">Borrar</button>
                                        </th>
                                    </tr>
